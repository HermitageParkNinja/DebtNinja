...
const SEQUENCES = {
  high: { name: "High Value / Assets", steps: [
    ...
    { day: 1, channel: "sms", action: "SMS with payment link", auto: true },
    { day: 2, channel: "call", action: "AI call - professional", auto: true },
    { day: 3, channel: "sms", action: "SMS chase", auto: true },
    { day: 4, channel: "email", action: "Second demand - tone shift", auto: true },
    { day: 5, channel: "call", action: "AI call - firm", auto: true },
    { day: 7, channel: "whatsapp", action: "WhatsApp - direct", auto: true },
    { day: 10, channel: "call", action: "AI call - final", auto: true },
    { day: 12, channel: "letter", action: "Posted pre-action letter", auto: false },
    { day: 14, channel: "legal", action: "Escalate to litigation", auto: false },
  ]},
  medium: { name: "Standard Recovery", steps: [
    { day: 1, channel: "email", action: "Formal demand with payment link", auto: true },
    { day: 1, channel: "payment", action: "Stripe link generated", auto: true },
    { day: 2, channel: "sms", action: "SMS reminder", auto: true },
    { day: 3, channel: "call", action: "AI call - professional", auto: true },
    { day: 5, channel: "email", action: "Second demand", auto: true },
    { day: 7, channel: "sms", action: "SMS chase", auto: true },
    { day: 10, channel: "call", action: "AI call - firm", auto: true },
    { day: 14, channel: "whatsapp", action: "WhatsApp - direct", auto: true },
    { day: 18, channel: "call", action: "AI call - final", auto: true },
    { day: 21, channel: "letter", action: "Pre-action letter", auto: false },
    { day: 28, channel: "legal", action: "Escalate", auto: false },
  ]},
  low: { name: "Light Touch", steps: [
    { day: 1, channel: "email", action: "Demand with payment link", auto: true },
    { day: 1, channel: "payment", action: "Stripe link generated", auto: true },
    { day: 3, channel: "sms", action: "SMS reminder", auto: true },
    { day: 7, channel: "call", action: "AI call - professional", auto: true },
    { day: 10, channel: "email", action: "Second demand", auto: true },
    { day: 14, channel: "sms", action: "SMS chase", auto: true },
    { day: 21, channel: "call", action: "AI call - firm", auto: true },
    { day: 28, channel: "email", action: "Final demand", auto: true },
    { day: 35, channel: "legal", action: "Review for escalation", auto: false },
  ]},
};
