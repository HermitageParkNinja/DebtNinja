...
const SEQUENCES = {
  high: [
    ...
    { day: 1, channel: "sms", template: "initial_chase", auto: true },
    { day: 2, channel: "call", tone: "professional", auto: true },
    { day: 3, channel: "sms", template: "payment_reminder", auto: true },
    { day: 4, channel: "email", template: "second_demand", auto: true },
    { day: 5, channel: "call", tone: "firm", auto: true },
    { day: 7, channel: "whatsapp", template: "urgent", auto: true },
    { day: 10, channel: "call", tone: "final", auto: true },
    { day: 12, channel: "letter", auto: false },
    { day: 14, channel: "legal", auto: false },
  ],
  medium: [
    { day: 1, channel: "email", template: "initial_demand", auto: true },
    { day: 1, channel: "payment", auto: true },
    { day: 2, channel: "sms", template: "initial_chase", auto: true },
    { day: 3, channel: "call", tone: "professional", auto: true },
    { day: 5, channel: "email", template: "second_demand", auto: true },
    { day: 7, channel: "sms", template: "payment_reminder", auto: true },
    { day: 10, channel: "call", tone: "firm", auto: true },
    { day: 14, channel: "whatsapp", template: "urgent", auto: true },
    { day: 18, channel: "call", tone: "final", auto: true },
    { day: 21, channel: "letter", auto: false },
    { day: 28, channel: "legal", auto: false },
  ],
  low: [
    { day: 1, channel: "email", template: "initial_demand", auto: true },
    { day: 1, channel: "payment", auto: true },
    { day: 3, channel: "sms", template: "initial_chase", auto: true },
    { day: 7, channel: "call", tone: "professional", auto: true },
    { day: 10, channel: "email", template: "second_demand", auto: true },
    { day: 14, channel: "sms", template: "payment_reminder", auto: true },
    { day: 21, channel: "call", tone: "firm", auto: true },
    { day: 28, channel: "email", template: "final_demand", auto: true },
    { day: 35, channel: "legal", auto: false },
  ],
}
